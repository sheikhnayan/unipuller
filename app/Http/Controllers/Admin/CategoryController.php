...
class CategoryController extends AdminBaseController
{
    ...
    {
        return view('admin.category.vendorcsv');
    }
    ...
    public function importSubmit(Request $request)
    {
        ...
        while (($line = fgetcsv($file)) !== FALSE) {
            ...
            if ($i != 1) {
                ...
                if (!Category::where('name', $line[0])->exists()) {
                    //--- Validation Section Ends
                    ...
                    $log .= "<br>" . __('Row No') . ": " . $i . " - " . __('Duplicate Category!') . "<br>";
                }
            }
        ...
        //--- Redirect Section
        $msg = __('Bulk Category File Imported Successfully.') . $log;
        return response()->json($msg);
    }
}