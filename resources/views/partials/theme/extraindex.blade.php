...
<div class="full-row bg-light">
    <div class="container">
        ...
        <div class="col-lg-5">
                 <span class="text-secondary pb-2 d-table tagline mx-auto text-uppercase text-center">{{ __('Services') }}</span>
                 <h2 class="main-title mb-4 text-center text-secondary">{{ __('We Providing Helpful Services') }}</h2>
             </div>
        </div>
                ...
                <div class="col-6 col-sm-4 col-lg-2 col-xl-2 custom-service text-center">
                    <a href="{{route('front.service_category', $data->slug)}}">
                        <div class="simple-service">
                            <img class="lazy" data-src="{{ asset('assets/images/categories/'.$data->photo) }}" alt="">
                        </div>
