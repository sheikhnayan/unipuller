                ...
                <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover nav-line-active">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-md-2">
                            ...
                            <li class="nav-item dropdown {{ request()->path() == '/service_category' ? 'active':''}}">
                                <a class="nav-link dropdown-toggle" href="{{ route('front.service_category') }}">{{ __('Service') }}</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <div class="tab-pane fade show active woocommerce-Tabs-panel woocommerce-Tabs-panel--description" id="pills-push-menu" role="tabpanel" aria-labelledby="pills-push-menu-tab">
                                            <div class="push-navbar">
                                                <ul class="navbar-nav">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('front.service_category') }}">{{ __('Service') }}</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{ route('vendor.list') }}">{{ __('Shop') }}</a>
                                                    </li>
