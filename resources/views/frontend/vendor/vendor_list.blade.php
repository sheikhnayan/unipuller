    ...
    <div class="row mobile-reverse">
      <div class="col-xl-3">
        <div class="advertise-banner">
          ...
          <img class="text-center mb-2" src="{{asset('/assets/front/images/social.png')}}" alt="">
          ...
          <div class="d-flex mt-3 justify-content-between">
            <a href="{{route('vendor.register')}}" target="_blank"><button class="btn btn-primary mr-2">Get Started</button></a>
      ...
      <div class="col-xl-9">
        <div class="product-search-one">
          <form id="searchForm" class="search-form form-inline search-pill-shape" action="{{ route('vendor.list') }}" method="GET">
            ...
            <input type="text" id="shop_name" class="col form-control search-field" name="search" placeholder="Search Location or Shop For" value="{{ request()->input('search') }}">
            ...
            <div class="select-appearance-none categori-container" id="catSelectForm">
              <select name="category" class="form-control categoris" id="category_select">
                ...
                <option value="{{ $data->slug }}" {{ request()->input('category') == $data->slug ? 'selected' : '' }}>
                  {{ $data->name }}
                </option>
                @endforeach
              </select>
              ...
              <div class="product type-product">
                <div class="product-wrapper">
                  ...
                  <div class="product-info">
                    ...
                    <div @if(strlen($vendor->shop_name) > 22) class="shipping-feed-back mt-0" @else class="shipping-feed-back2 mt-0" @endif>
                      <div class="star-rating">
                        <div class="rating-wrap">
                          <p><i class="fas fa-star"></i><span> {{ App\Models\Rating::ratings($vendor->id) }} ({{ App\Models\Rating::ratingCount($vendor->id) }})</span></p>
                        </div>
                      </div>
                    </div>
