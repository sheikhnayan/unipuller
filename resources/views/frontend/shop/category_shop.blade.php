...
<div class="full-row bg-light">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <h2 class="main-title mb-4 text-center text-secondary">{{ __('Shop') }}</h2>
        ...
        <div class="row g-3">
            @foreach ($shops as $data)
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <a href="{{ route('vendor.shop.service', $data->id) }}">
                        <div class="simple-service">
                            <img class="lazy" data-src="{{ asset('assets/images/categories/'.$data->shop_image) }}" alt="">
                        </div>
                        <p class="text-center">{{ $data->shop_name }}</p>
                    </a>
                </div>
            @endforeach
        </div>
