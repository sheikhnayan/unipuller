...
<div class="container meetup-section p-4">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-3 col-md-4 col-sm-12 text-center py-2 ">
            <a href="{{ route('vendor.shop.service', 5621) }}" class="text-decoration-none text-secondary">
                <div class="flip-card ">
                    <div class="flip-card-inner position-relative">
                        <div class="flip-card-front ">
                            <img src="{{ asset('assets/front/images/star-meetup/cel-1.png') }}" alt="Avatar"
                            ...
                            <ul class="list-group border-0 position-absolute bottom-0 start-0">
                                <li class="list-group-item">
                                    ...
                                    </svg> <span class="fw-bold">John </span>
                                </li>
                                <li class="list-group-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 text-center py-2 ">
            <a href="{{ route('vendor.shop.service', 5621) }}" class="text-decoration-none text-secondary">
                ...
                <div class="flip-card ">
                    <div class="flip-card-inner position-relative">
                        <div class="flip-card-front ">
                            <img src="{{ asset('assets/front/images/star-meetup/cel-2.png') }}" alt="Avatar"
                                style="width:300px;height:300px;">
                            <ul class="list-group border-0 position-absolute bottom-0 start-0">
                                <li class="list-group-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 text-center py-2 ">
            <a href="{{ route('vendor.shop.service', 5621) }}" class="text-decoration-none text-secondary">
                <div class="flip-card ">
                    <div class="flip-card-inner position-relative">
                        <div class="flip-card-front ">
                            <img src="{{ asset('assets/front/images/star-meetup/cel-3.png') }}" alt="Avatar"
                                style="width:300px;height:300px;">
                            <ul class="list-group border-0 position-absolute bottom-0 start-0">
                                <li class="list-group-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 text-center py-2 ">
            <a href="{{ route('vendor.shop.service', 5621) }}" class="text-decoration-none text-secondary">
                ...
                <div class="flip-card ">
                    <div class="flip-card-inner position-relative">
                        <div class="flip-card-front ">
                            <img src="{{ asset('assets/front/images/star-meetup/cel-4.png') }}" alt="Avatar"
                                style="width:300px;height:300px;">
                            <ul class="list-group border-0 position-absolute bottom-0 start-0">
                                <li class="list-group-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 text-center py-2 ">
            <a href="{{ route('vendor.shop.service', 5621) }}" class="text-decoration-none text-secondary">
                <div class="flip-card ">
                    <div class="flip-card-inner position-relative">
                        <div class="flip-card-front ">
                            <img src="{{ asset('assets/front/images/star-meetup/cel-5.png') }}" alt="Avatar"
                                style="width:300px;height:300px;">
                            <ul class="list-group border-0 position-absolute bottom-0 start-0">
                                <li class="list-group-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 text-center py-2 ">
            <a href="{{ route('vendor.shop.service', 5621) }}" class="text-decoration-none text-secondary">
                <div class="flip-card ">
                    <div class="flip-card-inner position-relative">
                        <div class="flip-card-front ">
                            <img src="{{ asset('assets/front/images/star-meetup/cel-6.png') }}" alt="Avatar"
                                style="width:300px;height:300px;">
                            <ul class="list-group border-0 position-absolute bottom-0 start-0">
                                <li class="list-group-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
