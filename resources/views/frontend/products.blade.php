...
<div class="full-row bg-light overlay-dark py-5" style="background-image: url({{ asset('assets/front/images/product.jpg') }}); background-position: center center; background-size: cover;">
   <div class="container">
